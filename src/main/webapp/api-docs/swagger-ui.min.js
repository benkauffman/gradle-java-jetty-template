(function () {
    ...
    !function () {
        ...
        return void 0 === e ? "" : (t = sanitizeHtml(e, {
            ...
            allowedAttributes: {div: ["class"], span: ["class"], a: ["href"]}
        ...
        if (e.format && "password" === e.format && (n = "password"), l && (r = " id='" + l + "'"), o = sanitizeHtml(o), a)t = "<textarea class='body-textarea" + (e.required ? " required" : "") + "' name='" + s + "'" + r + u, t += " placeholder='Provide multiple values in new lines" + (e.required ? " (at least one required)." : ".") + "'>", t += o + "</textarea>"; else {
            var c = "parameter";
            ...
            34: [function (e, t, n) {
                ...
                s.prototype._stateText = function (e) {
                    ...
                    ">" === e || r(e) ? (this._special = me,
                        this._state = v, this._sectionStart = this._index - 6, this._index--) : this._state = f
        ...
        return function n(e, t, r) {
            ...
            3: [function (e, t, n) {
                ...
                g.prototype.initialize = function (e, t) {
                    ...
                    var h = this;
                    h.apis.help = r.bind(h.help, h), r.forEach(e.paths, function (e, t) {
                    ...
                    var g = [];
                    return r.forEach(Object.keys(n), function (e) {
                        var t;
                        for (t in h.apisArray) {
                            var n = h.apisArray[t];
                            n && e === n.name && (g.push(n), h.apisArray[t] = null)
                        }
                    }), r.forEach(h.apisArray, function (e) {
                        e && g.push(e)
                    }), h.apisArray = g, r.forEach(e.definitions, function (e, t) {
            ...
            5: [function (t, n, r) {
                ...
                c.prototype.execute = function (t, n) {
                    ...
                    "delete" === t && (t = "del");
                    var n = e.headers || {}, r = a[t](e.url);
                    if (e.enableCookies && r.withCredentials(), e.body)if (s.isObject(e.body)) {
                        var l = e.headers["Content-Type"] || "";
                        if (0 === l.indexOf("multipart/form-data"))if (delete n["Content-Type"], "[object FormData]" === {}.toString.apply(e.body))for (var u = e.body.keys(); ;) {
                            var c = u.next();
                            if (c.done)break;
                            var p = c.value, h = e.body.get(p);
                            console.log({}.toString.apply(h)), "[object File]" === {}.toString.apply(h) ? r.attach(p, h) : r.field(p, h)
                        } else {
                            var f;
                            for (var f in e.body) {
                                var h = e.body[f];
                        ...
                        } else s.isObject(e.body) && (e.body = JSON.stringify(e.body), r.send(e.body))
                    } else r.send(e.body);
                    var d;
                    for (d in n)r.set(d, n[d]);
                    "function" == typeof r.buffer && r.buffer(), r.end(function (t, n) {
                        ...
                        if (!t && n.error && (t = n.error), t && e.on && e.on.error) {
                            ...
                            var u;
                            if (n.body && s.keys(n.body).length > 0)u = n.body; else try {
                                u = o.safeLoad(n.text), u = "string" == typeof u ? null : u
                            } catch (l) {
                                i.log("cannot parse JSON/YAML content")
                            }
                            a.obj = "object" == typeof u ? u : null, a.status = n.status, a.statusText = n.text, r = e.on.response
                        }
            ...
            6: [function (e, t, n) {
                ...
                a.prototype.processAllOf = function (e, t, n, r, i, a) {
                    ...
                    for (f in e.definitions) {
                        var _ = e.definitions[f];
                        if (_.$ref)this.resolveInline(l, e, _, w, b, _); else {
                            for (g in _.properties)m = _.properties[g], i.isArray(m.allOf) ? this.processAllOf(l, f, m, w, b, e) : this.resolveTo(l, m, w, "/definitions");
                            _.allOf && this.processAllOf(l, f, _, w, b, e)
                        }
                    }
                    e.parameters = e.parameters || {};
                    for (f in e.parameters) {
                        var x = e.parameters[f];
                        if ("body" === x["in"] && x.schema)if (i.isArray(x.schema.allOf)) {
                            for (var A = "inline_model", f = A, S = !1, j = 0; !S;) {
                            ...
                            e.definitions[f] = {allOf: x.schema.allOf}, delete x.schema.allOf, x.schema.$ref = "#/definitions/" + f, this.processAllOf(l, f, e.definitions[f], w, b, e)
                        } else this.resolveTo(l, x.schema, w, o);
                        x.$ref && this.resolveInline(l, e, x, w, b, x.$ref)
                    }
                    for (f in e.paths) {
                        var E, O, k;
                        d = e.paths[f];
                        for (E in d)if ("$ref" === E)o = "/paths" + f, this.resolveInline(l, e, d, w, b, o); else {
                            O = d[E];
                            var T = d.parameters || [], C = O.parameters || [];
                            for (s in T) {
                                var x = T[s];
                                C.unshift(x)
                            }
                            "parameters" !== E && i.isObject(O) && (O.parameters = O.parameters || C);
                            for (s in C) {
                                var x = C[s];
                                if (o = "/paths" + f + "/" + E + "/parameters", "body" === x["in"] && x.schema)if (i.isArray(x.schema.allOf)) {
                                    for (var A = "inline_model", f = A, S = !1, j = 0; !S;) {
                                        if ("undefined" == typeof e.definitions[f]) {
                                            S = !0;
                                            break
                            ...
                            for (k in O.responses) {
                                var I = O.responses[k];
                                if (o = "/paths" + f + "/" + E + "/responses/" + k, i.isObject(I) && (I.$ref && this.resolveInline(l, e, I, w, b, o), I.schema)) {
                                    var D = I;
                                    if (i.isArray(D.schema.allOf)) {
                                        for (var A = "inline_model", f = A, S = !1, j = 0; !S;) {
                                            if ("undefined" == typeof e.definitions[f]) {
                                                S = !0;
                                                break
                                        ...
                                        e.definitions[f] = {allOf: D.schema.allOf}, delete D.schema.allOf, delete D.schema.type, D.schema.$ref = "#/definitions/" + f, this.processAllOf(l, f, e.definitions[f], w, b, e)
                                    } else"array" === D.schema.type ? D.schema.items && D.schema.items.$ref && this.resolveInline(l, e, D.schema.items, w, b, o) : this.resolveTo(l, I.schema, w, o)
                                }
                            }
                        }
                        d.parameters = []
                    ...
                    for (s = 0; s < U.length; s++) {
                        ...
                        if (l === P.root) {
                            if ("ref" === P.resolveAs) {
                                var q, B = ((P.root || "") + "/" + P.key).split("/"), N = [], z = "";
                                if (P.key.indexOf("../") >= 0) {
                                    for (var $ = 0; $ < B.length; $++)".." === B[$] ? N = N.slice(0, N.length - 1) : N.push(B[$]);
                                    for (q = 0; q < N.length; q++)q > 0 && (z += "/"), z += N[q];
                                    P.root = z, R.push(P)
                                } else if (L = P.key.split("#"), 2 === L.length) {
                                    0 !== L[0].indexOf("http:") && 0 !== L[0].indexOf("https:") || (P.root = L[0]), o = L[1].split("/");
                                    var F, V = e;
                                    for (q = 0; q < o.length; q++) {
                                        var H = o[q];
                                        if ("" !== H) {
                                            if (V = V[H], "undefined" == typeof V) {
                                                F = null;
                                                break
                                            }
                                            F = V
                            ...
                            } else if ("inline" === P.resolveAs) {
                                if (P.key && P.key.indexOf("#") === -1 && "/" !== P.key.charAt(0)) {
                                    for (L = P.root.split("/"), o = "", s = 0; s < L.length - 1; s++)o += L[s] + "/";
                                    o += P.key, P.root = o, P.location = ""
                                }
                                R.push(P)
                            }
                        } else R.push(P)
                    ...
                    M = R.length;
                    for (var Y = {}, J = 0; J < R.length; J++)!function (e, t, n, a, o) {
                        if (e.root && e.root !== l)if (n.failedUrls.indexOf(e.root) === -1) {
                            var s = {
                                ...
                                on: {
                                    error: function (r) {
                                        y += 1, console.log("failed url: " + s.url), n.failedUrls.push(s.url), a && delete a[e.root], b[e.key] = {
                                            root: e.root,
                                            location: e.location
                                        }, y === M && n.finish(t, h, w, v, b, u)
                                    }, response: function (r) {
                                        var i = r.obj;
                                        a && delete a[e.root], n.resolverCache && (n.resolverCache[e.root] = i), n.resolveItem(i, e.root, w, v, b, e), y += 1, y === M && n.finish(t, h, w, v, b, u)
                                    }
                                }
                            };
                            c && c.clientAuthorizations && c.clientAuthorizations.apply(s), function f() {
                                setTimeout(function () {
                                    if (a[s.url])f(); else {
                                        var e = n.resolverCache[s.url];
                                        i.isObject(e) ? (s.on.response({obj: e}), 1) : (a[s.url] = !0, (new r).execute(s, p))
                                    }
                                }, 0)
                            }()
                        } else y += 1, b[e.key] = {
                    ...
                    0 === Object.keys(R).length && this.finish(e, h, w, v, b, u)
                    ...
                    for (s in n) {
                        ...
                        if (c)if (e.definitions = e.definitions || {}, "ref" === l.resolveAs) {
                            if (o !== !0)for (u in c.obj) {
                                var p = this.retainRoot(u, c.obj[u], l.root);
                                c.obj[u] = p
                            }
                            ...
                            for (u in c.obj) {
                                var p = c.obj[u];
                                o !== !0 && (p = this.retainRoot(u, c.obj[u], l.root)), h[u] = p
                            }
                        }
                    }
                    ...
                    return n
                }, a.prototype.retainRoot = function (e, t, n) {
                    if (i.isObject(t))for (var r in t) {
                        var a = t[r];
                        if ("$ref" === r && "string" == typeof a) {
                            if (0 !== a.indexOf("http:") && 0 !== a.indexOf("https:")) {
                                ...
                                if (n) {
                                    var s = n.slice(-1);
                                    if ("/" !== s && 0 !== a.indexOf("#") && 0 !== a.indexOf("http:") && a.indexOf("https:")) {
                                        o = !1;
                                        var l = n.split("/");
                                        l = l.splice(0, l.length - 1), n = "";
                                        for (var u = 0; u < l.length; u++)n += l[u] + "/"
                                    }
                                }
                                0 !== a.indexOf("#") && o && (a = "#" + a), a = (n || "") + a, t[r] = a
                            }
                        } else i.isObject(a) && this.retainRoot(r, a, n)
                    } else i.isString(t) && "$ref" === e && t.indexOf("http:") === -1 && t.indexOf("https:") === -1 && (t = n + t);
                    return t
                    ...
                    if ("undefined" != typeof s && null !== s) {
                        if (s.indexOf("#") >= 0) {
                            var u = s.split("#");
                            if (u[0] && 0 === s.indexOf("/")); else if (!u[0] || 0 !== u[0].indexOf("http:") && 0 !== u[0].indexOf("https:")) {
                                if (u[0] && u[0].length > 0) {
            ...
            7: [function (e, t, n) {
                ...
                function s(e, t, n, i) {
                    ...
                    function o(e) {
                        ...
                        return e.$ref ? t += a(e, l.simpleRef(e.$ref)) : "object" === n ? t += u.isUndefined(e.properties) ? "object" : a(e) : "array" === n ? (t += "Array[", u.isArray(e.items) ? t += u.map(e.items, a).join(",") : u.isPlainObject(e.items) ? t += u.isUndefined(e.items.$ref) ? u.isUndefined(e.items.type) || u.indexOf(["array", "object"], e.items.type) !== -1 ? a(e.items) : e.items.type : a(e.items, l.simpleRef(e.items.$ref)) : (l.log("Array type's 'items' schema is not an array or an object, cannot process"), t += "object"), t += "]") : t += e.type, t += "</span>"
                    }
                        ...
                        if (t && d.push(t), c)u.isArray(e.items) ? f += "<div>" + u.map(e.items, function (e) {
                            ...
                            if (u.isPlainObject(e.properties)) {
                                var m = u.map(e.properties, function (t, r) {
                                    ...
                                    return h["default"] = i(h), h = l.resolveSchema(h), c = t.description || h.description, u.isUndefined(h.$ref) || (a = n[l.simpleRef(h.$ref)], u.isUndefined(a) || u.indexOf([void 0, "array", "object"], a.definition.type) !== -1 || (h = l.resolveSchema(a.definition))), d += o(h), p || (d += ', <span class="propOptKey">optional</span>'), t.readOnly && (d += ', <span class="propReadOnly">read only</span>'), d += ")", u.isUndefined(c) || (d += ': <span class="propDesc">' + c + "</span>"), h["enum"] && (d += ' = <span class="propVals">[\'' + h["enum"].join("', '") + "']</span>"), "<div" + (t.readOnly ? ' class="readOnly"' : "") + ">" + s(h, d)
                                }).join(",</div>");
                                m && (f += m + "</div>")
                            }
            ...
            8: [function (e, t, n) {
                ...
                a.prototype.setDocumentationLocation = function (e) {
                    ...
                    for (n && n.swaggerRequestHeaders && (p = n.swaggerRequestHeaders), 0 === l && this.finish(i, t), a = 0; a < l; a++) {
                        ...
                        var m = {url: d, headers: {accept: p}, on: {}, method: "get"};
            ...
            10: [function (e, t, n) {
                ...
                var i = {
                    ...
                    for (p = 0; p < this.parameters.length; p++) {
                        ...
                        var y = d["enum"] || d.items && d.items["enum"];
                        if ("undefined" != typeof y) {
                            var v;
                            for (d.allowableValues = {}, d.allowableValues.values = [], d.allowableValues.descriptiveValues = [], v = 0; v < y.length; v++) {
                                var b = y[v], w = b === d["default"] || b + "" === d["default"];
                                d.allowableValues.values.push(b), d.allowableValues.descriptiveValues.push({
                                    value: b + "",
                                    isDefault: w
                                })
                            }
                    ...
                    var _, x, A = this.responses;
                    if (A[200] ? (x = A[200], _ = "200") : A[201] ? (x = A[201], _ = "201") : A[202] ? (x = A[202], _ = "202") : A[203] ? (x = A[203], _ = "203") : A[204] ? (x = A[204], _ = "204") : A[205] ? (x = A[205], _ = "205") : A[206] ? (x = A[206], _ = "206") : A["default"] && (x = A["default"], _ = "default"), x && x.schema) {
                        var S, j = this.resolveModel(x.schema, s);
                        delete A[_], j ? (this.successResponse = {}, S = this.successResponse[_] = j) : x.schema.type && "object" !== x.schema.type && "array" !== x.schema.type ? (this.successResponse = {}, S = this.successResponse[_] = x.schema) : (this.successResponse = {}, S = this.successResponse[_] = new o((void 0), x.schema || {}, this.models, e.modelPropertyMacro)), S && (x.description && (S.description = x.description), x.examples && (S.examples = x.examples), x.headers && (S.headers = x.headers)), this.type = x
                    }
                ...
                u.prototype.isDefaultArrayItemValue = function (e, t) {
                    ...
                    for (var r, i, a, o, s = {}, l = !1, u = 0; u < this.parameters.length; u++) {
                        ...
                        "undefined" != typeof t[c.name] ? "body" === c["in"] ? i = t[c.name] : "formData" === c["in"] && (s[c.name] = {
                            param: c,
                            value: t[c.name]
                        }, r = !0) : "body" === c["in"] && (l = !0)
                    }
                    ...
                    if (e["Content-Type"] && e["Content-Type"].indexOf("multipart/form-data") >= 0 && (h = !0), r && !h) {
                        ...
                        for (a in s) {
                            var c = s[a].param;
                            o = s[a].value, "undefined" != typeof o && (Array.isArray(o) ? ("" !== f && (f += "&"), f += this.encodeQueryCollection(c.collectionFormat, a, o)) : ("" !== f && (f += "&"), f += encodeURIComponent(a) + "=" + encodeURIComponent(o)))
                        }
                        i = f
                    } else if (h) {
                        if ("function" == typeof FormData) {
                            var d = new FormData;
                            d.type = "formData";
                            for (a in s)o = t[a], "undefined" != typeof o && ("[object File]" === {}.toString.apply(o) ? d.append(a, o) : "file" === o.type && o.value ? d.append(a, o.value) : Array.isArray(o) ? d.append(a, this.encodeQueryCollection(c.collectionFormat, a, o)) : d.append(a, o));
                            i = d
                        } else {
                            d = {};
                            for (a in s)if (o = t[a], Array.isArray(o)) {
                                var m, g = c.collectionFormat || "multi";
                                m = "ssv" === g ? " " : "pipes" === g ? "|" : "tsv" === g ? "\t" : ",";
                                var y;
                    ...
                    for (g in y)b[g] = y[g];
                    for (g in v)b[g] = v[g];
                    var w = this.getBody(v, h, f), _ = this.urlify(h);
                    if (_.indexOf(".{format}") > 0 && b) {
                        var x = b.Accept || b.accept;
                        x && x.indexOf("json") > 0 ? _ = _.replace(".{format}", ".json") : x && x.indexOf("xml") > 0 && (_ = _.replace(".{format}", ".xml"))
                    }
                    var A = {
                        url: _,
                        ...
                        jqueryAjaxCache: f.jqueryAjaxCache,
                        deferred: p,
                        headers: b,
                        clientAuthorizations: f.clientAuthorizations,
                        on: {
                            response: function (e) {
                            ...
                            if (c) {
                                ...
                                for (var f = 0; f < this.parameters.length; f++) {
                                    ...
                                    if ("formData" === d["in"]) {
                                        h || (h = "");
                                        var m;
                                        m = "function" == typeof FormData && a.body instanceof FormData ? a.body.get(d.name) : a.body[d.name], m && ("file" === d.type ? m.name && (h += "-F " + d.name + '=@"' + m.name + '" ') : (h += "-F ", h += Array.isArray(m) ? this.encodeQueryCollection(d.collectionFormat, d.name, m) : this.encodeQueryKey(d.name) + "=" + m, h += " "))
                                    }
                                }
                            }
            ...
            134: [function (e, t, n) {
                ...
                "../lang/isArguments": 139, "../lang/isArray": 140, "../lang/isString": 146, "../object/keysIn": 150,
                "./isIndex": 121, "./isLength": 125
            }],
            135: [function (e, t, n) {
                function r(e) {
            ...
            158: [function (e, t, n) {
                ...
                function s(e) {
                    for (var t, n, r = {}, i = e.split("&"), a = 0, o = i.length; a < o; ++a)n = i[a], t = n.split("="), r[decodeURIComponent(t[0])] = decodeURIComponent(t[1]);
                    return r
                }
                ...
                function l(e) {
                    ...
                    a.pop();
                    for (var s = 0, l = a.length; s < l; ++s)n = a[s], t = n.indexOf(":"), r = n.slice(0, t).toLowerCase(), i = _(n.slice(t + 1)), o[r] = i;
                    return o
                }
                ...
                var m, g = e("emitter"), y = e("reduce"), v = e("./request-base"), b = e("./is-object");
                m = "undefined" != typeof window ? window : "undefined" != typeof self ? self : this;
                var w = t.exports = e("./request").bind(null, f);
                w.getXHR = function () {
                ...
                w.serializeObject = a, w.parseString = s, w.types = {
                    ...
                    return !t && u(this.type) && (t = w.parse["application/json"]), t && e && (e.length || e instanceof Object) ? t(e) : null
                ...
                }, w.Response = h, g(f.prototype);
                for (var x in v)f.prototype[x] = v[x];
                f.prototype.abort = function () {
                    ...
                    var t = b(e), n = this._header["content-type"];
                    if (t && b(this._data))for (var r in e)this._data[r] = e[r]; else"string" == typeof e ? (n || this.type("form"), n = this._header["content-type"], "application/x-www-form-urlencoded" == n ? this._data = this._data ? this._data + "&" + e : e : this._data = (this._data || "") + e) : this._data = e;
                    ...
                    var t = this, n = this.xhr = w.getXHR(), a = this._query.join("&"), o = this._timeout, s = this._formData || this._data;
                    ...
                    if (o && !this._timer && (this._timer = setTimeout(function () {
                        ...
                        }, o)), a && (a = w.serializeObject(a), this.url += ~this.url.indexOf("?") ? "&" + a : "?" + a), this.username && this.password ? n.open(this.method, this.url, !0, this.username, this.password) : n.open(this.method, this.url, !0), this._withCredentials && (n.withCredentials = !0), "GET" != this.method && "HEAD" != this.method && "string" != typeof s && !i(s)) {
                        var p = this._header["content-type"], h = this._parser || w.serialize[p ? p.split(";")[0] : ""];
                        !h && u(p) && (h = w.serialize["application/json"]), h && (s = h(s))
                    }
                ...
                }, w.Request = f, w.get = function (e, t, n) {
                    var r = w("GET", e);
            ...
            }, {"./is-object": 159, "./request": 161, "./request-base": 160, emitter: 162, reduce: 163}],
            159: [function (e, t, n) {
                function r(e) {
            ...
            163: [function (e, t, n) {
                t.exports = function (e, t, n) {
                    for (var r = 0, i = e.length, a = 3 == arguments.length ? n : e[r++]; r < i;)a = t.call(null, a, e[r], ++r, e);
                    return a
                }
            }, {}]
        }, {}, [1])(1)
        ...
        render: function () {
            ...
            if (Array.isArray(this.model.security)) {
                ...
                F.isLogout = !_.isEmpty(window.swaggerUi.api.clientAuthorizations.authz), this.authView = new SwaggerUi.Views.AuthButtonView({
                    data: F,
                    router: this.router,
                    isOperation: !0,
        ...
        showStatus: function (e) {
            ...
            if (n)if ("application/json" === i || /\+json$/.test(i)) {
                ...
                var c = i || "text/html", p = new Blob([n], {type: c}), h = document.createElement("a"), f = window.URL.createObjectURL(p), d = e.url.substr(e.url.lastIndexOf("/") + 1), m = [c, d, f].join(":"), g = r["content-disposition"] || r["Content-Disposition"];
            ...
            if (w.showRequestHeaders) {
                var x = $(".sandbox", $(this.el)), A = this.getInputMap(x), S = this.model.getHeaderParams(A);
                delete S["Content-Type"], $(".request_headers", $(this.el)).html("<pre>" + _.escape(JSON.stringify(S, null, "  ")).replace(/\n/g, "<br>") + "</pre>")
            }
